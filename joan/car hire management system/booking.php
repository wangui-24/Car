    ...
    <form method="POST" action="book.php" class="form-groups">
      <div class="d-flex">
        ...
        <div class="text-center">
          <button type="submit"class="btn btn-lg btn-success text-white" name="submit">BOOK</button>
        </div>
  ...
  <div class="container text-white">
      <div class="row py-5">
          <div class="col-md-4 ">
              ...
              <p>welcome to our company we believe your expectation is what we provide .make transportation faster and confortable with 100%convinience <br><b><i>for for information feel free to call us at</i></b></p>
              <p>+254759810154</p>
